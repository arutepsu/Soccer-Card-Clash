...
class DefenderFieldRefillStrategy extends IDefenderFieldRefillStrategy {

  override def refill(gameCards: IGameCards, defender: IPlayer): IGameCards = {
...
trait IDefenderFieldRefillStrategy {
