...
//import de.htwg.se.soccercardclash.view.gui.components.uiFactory.{BoostLoader, CardAnimationFactory}
//
//class SelectablePlayersFieldBar(player: IPlayer, playingField: IGameState) extends PlayersFieldBar(player, playingField) {
//
