...
class SingleAttackStrategySpec extends AnyWordSpec with Matchers {
  ...
  class TestableSingleAttackStrategy(index: Int, revertBoostStrategy: IRevertBoostStrategy)
    extends SingleAttackStrategy(index, revertBoostStrategy) {
  ...
  "processDefenderAttack" should {
    "return updated state when attacker wins" in {
      ...
      val strategy: TestableSingleAttackStrategy = new TestableSingleAttackStrategy(0, revertStrategy)
  ...
  class TestableSingleAttackStrategy2(
                                      index: Int,
                                      revertStrategy: IRevertBoostStrategy
                                    ) extends SingleAttackStrategy(index, revertStrategy) {
  ...
  "handleTie" should {
    "handle tie and attacker wins the tiebreaker" in {
      ...
      val strategy = new TestableSingleAttackStrategy2(0, revertStrategy)
