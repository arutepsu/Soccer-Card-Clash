...
import de.htwg.se.soccercardclash.model.gameComponent.action.strategy.trigger.boost.revert.{RevertBoostStrategy, RevertCard}
...
class RevertBoostStrategySpec extends AnyWordSpec with Matchers with MockitoSugar {
  ...
  "RevertBoostStrategy" should {
    "revert a boosted card using RevertCard" in {
      ...
      val roles = mock[de.htwg.se.soccercardclash.model.gameComponent.components.IRoles]
