...
class CardFactorySpec extends AnyWordSpec with Matchers {
  ...
  // ✅ Create an instance of CardFactory
  ...
  "CardFactory" should {
    ...
    "create a RegularCard with the correct suit and value" in {
      ...
      card shouldBe a[RegularCard] // ✅ Check type
      card.value shouldBe Value.Ten // ✅ Check value
      card.suit shouldBe Suit.Hearts // ✅ Check suit
    }
    ...
    "create multiple unique cards" in {
      ...
      card1 should not be card2 // ✅ Ensure different instances
    }
